...
<div class="relative overflow-hidden shadow-md rounded-lg mt-5">
    <table class="table-fixed w-full text-left">
        ...
        <tbody class="bg-white text-gray-500 bg-[#FFFFFF] text-[#6b7280]" style="background-color: #FFFFFF; color: #6b7280;">
            <tr class="py-3">
                <form action="" method="">
                <td class="py-3 border text-center  p-4" colspan="2">
                    <input class="w-full px-4 py-2 text-lg font-bold rounded-lg border focus:outline focus:outline-2 focus:outline-offset-2 bg-[#ffffff] text-[#444444] focus:outline-[#aaaaaa] border-[#cccccc]" placeholder="Listing Manager..">
                </td>
                
                <td class="py-3 border text-center  p-4">
                    <button class="font-bold rounded-lg text-xl  w-full h-12 bg-[#0062ff] text-[#ffffff] justify-center">Add Role</button>
                </td>
                </form>
            </tr>
        </tbody>
